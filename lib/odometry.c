 ...
 */
static void odom_calc_wheels_speeds(void)
{
        int i = 0;

        for (i = 0; i < 3; i++) {
                odom_ctrl->delta_enc_ticks[i] = *(odom_ctrl->p_enc_ticks[i]) -
                                                ENCODER_TIM_CNT_INITIAL_VALUE;
                *(odom_ctrl->p_enc_ticks[i]) = ENCODER_TIM_CNT_INITIAL_VALUE;
                odom_ctrl->wheel_speed[i] =
                (odom_ctrl->delta_enc_ticks[i] * TICKS_TO_RAD_COEF) /
 ...
 */
static void odom_calc_robot_speed(void)
{
        /*
 ...
 */
static void odom_calc_glob_params(void)
{
        /*
        ...
        odom_ctrl->coordinate[2] = odom_ctrl->coordinate[2] > 2 * PI_NUMBER ?
                                   odom_ctrl->coordinate[2] - 2 * PI_NUMBER :
                                   odom_ctrl->coordinate[2] < -2 * PI_NUMBER ?
                                   odom_ctrl->coordinate[2] + 2 * PI_NUMBER :
                                   odom_ctrl->coordinate[2];
        return;
}
